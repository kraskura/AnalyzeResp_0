...
<div class="well">
Trasnparent and open source work is our high priority. While this is not a formally formatted librarys, this is my first attempt to make it available to all and to make it citable.
My priority remains to re-work and organise the functions, and to make them installable via Github first, and also CRAN after some key progressions. 
</div>

<p style = "text-align:left; color: #325d88"> Author and maintainer: Krista Kraskura </p>
<p style = "text-align:left; color: #325d88"> Contributors: Emily Hardison, Terra Dressler, Jacey Van Wert, Sam Csik, Erika Eliason </p>
