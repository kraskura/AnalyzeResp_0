...
- Fork the repository from [GitHub](https://github.com/kraskura/AnalyzeResp_0) directly. Git code source: [https://github.com/kraskura/AnalyzeResp_0.git](https://github.com/kraskura/AnalyzeResp_0.git)
...
Anyone using aquatic respirometry in their work.
Our script is writtem to analyze data that was measured using [Firesting multichannel](https://www.pyroscience.com/en/263) oxygen sensor boxes from Pyroscience. But it can be easily adapted to be compatible with any other setup (demos on how to achieve this coming soon!). 
