...
<div class="page-header">
  ...
  <p>Source: <a href = "#" style = "color:gray;">https://github.com/kraskura/AnalyzeResp_0/blob/ccf6f96e629939be6b5f33f88e435a7b973e6fff/docs/MMR_SMR_AS_EPOC.rmd</a></p>
</div>
...
A flexible function that will estimate MMR, SMR, Aerobic scope, and several metrics describing recovery performance of a specific animal while taking in account i) the volume of respirometer, ii) the body mass of an individual, the iii) background respiration in the respirometer overnight. The iput files to this function are the output files genereted by running `SMR` and `MMR`. 
...
**mmr_type**             | (currently irrelevant)   | = `"min"`, # the standard way
...
[Chabot et al 2016, Journal of Fish Biology](http://doi.wiley.com/10.1111/jfb.12845)
