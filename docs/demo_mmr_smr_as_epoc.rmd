...
<div class="page-header">
  ...
  <p>Source: <a href = "https://github.com/kraskura/AnalyzeResp_0/blob/main/docs/demo_mmr_smr_as_epoc.rmd" style = "color:gray;">docs/demo_mmr_smr_as_epoc.rmd</a></p>
</div>  

<h4 style="color:#495057; font-weight: bold;  text-align: left">Steps and short descriptions</h4>
...
<h5 style = "font-weight: bold">
 ...
 border-radius: 5px;
 padding: 5px;"> STEP 1: &nbsp;</a> &nbsp; Set up, working directories, and formatting data files </h5>
...
_Note! - sorry for the strange not always intuitive names of the folder, please share any suggestions with preffered names of the files, directories and sub-directories_
...
<h5 style = "font-weight: bold"> <a name = "step2" style="color:black;
 ...
 border: 3px solid grey;
 border-radius: 5px;
 padding: 5px; "> STEP 2: &nbsp;</a> &nbsp; Analysis of MMR, finding the steepest slope  </h5>
...
MMR(data.MMR = "./jul04_2019_opasize_box4_mmr.csv", # specify the .csv data file
    ...
    Ch1 = 1, # an animal in channel 1 has the MMR measured in the first cycle. 
    Ch2 = 2, # an animal in channel 2 has the MMR measured in the second cycle. 
    Ch3 = 1, # an animal in channel 3 has the MMR measured in the first cycle. 
    Ch4 = 2, # an animal in channel 4 has the MMR measured in the second cycle. 
...
<h5 style = "font-weight: bold"> <a name = "step3" style="color:black;
 ...
 border: 3px solid grey;
 border-radius: 5px;
 padding: 5px;"> STEP 3 &nbsp;</a> &nbsp; Analysis of SMR slopes recorded on automatic cycles</h5>
...
**Outcome:** The same plots as before, but any specified section to be **used** for further analysis is indicated in grey shadowed box. 

**3. Likely third run: to estimate background respiration**
This exact same function can be run to analyze background respiration. If background was run on cycles that were not automatic, then best may be splitting the files up, or running the function through the `MMR` function.
...
<h5 style = "font-weight: bold"> <a name = "step4" style="color:black;
 ...
 border: 3px solid grey;
 border-radius: 5px;
 padding: 5px;"> STEP 4 &nbsp;</a> &nbsp; Estimating metabolic performances</h5>
...
Some example customization for desired outcomes:
  ...
  - `MLND = FALSE`: MLND method will not be used to estimate SMR.
...
Although, I suggest specifying a few arguments every single time and ignore their default value, those include:
  ...
  * `date_format = "m/d/y"` (the default) is the most common date format in Firesting .txt files, but if that is not the case for files on hnad, it will hit back an error.
...
<h5 style = "font-weight: bold"> <a name = "step5" style="color:black;
 ...
 border: 3px solid grey;
 border-radius: 5px;
 padding: 5px;"> STEP 5 &nbsp;</a> &nbsp; title title title  </h5>



<h5> <a name="setup" style="color:black; font-weight: bold;  text-align: center"> Aerobic scope, AS, and Excess post exercise oxygen consumption, EPOC</a></h5>
<br>
<a name = "step7" style="color:black;
 font-weight: bold;
 border: 3px solid grey;
 border-radius: 5px;
 padding: 5px;
